...
PREFIX = "alterdemo-app"

PROXY_BASE_URL = "https://35.189.248.12/alterdemo-proxy/"

CONFIG = {'Vodafone': {'app': 'rot_smart_homes_app', 'name': 'smeiling_dashboard_vodafone_demo_v10'}}
